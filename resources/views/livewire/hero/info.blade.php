    ...
    <div class="sm:text-center lg:text-left">
        ...
        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            ...
            <div class="mt-3 sm:mt-0 sm:ml-3">
                <x-actions.hero class="flex items-center justify-center px-8 py-3 md:py-4 md:px-10 text-yellow-300 hover:text-blue-300"/>
            </div>
        </div>
    </div>
    <x-modals.slideover :imageFile="$imageFile" :imageUrl="$imageUrl" :cvUrl="$cvUrl"/>
</main>
